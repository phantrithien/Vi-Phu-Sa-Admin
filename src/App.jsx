    ...
    return (
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#0F0F0F] text-vps-gold">Đang tải trang...</div>}>
            <Routes>
                ...
                <Route path="/app/settings" element={<ProtectedRoute><Guarded permissions={[PERMISSIONS.VIEW_SETTINGS]}><Settings /></Guarded></ProtectedRoute>} />
                ...
                <Route path={APP_ROUTES.SETTINGS} element={<ProtectedRoute><Guarded permissions={[PERMISSIONS.VIEW_SETTINGS]}><Settings /></Guarded></ProtectedRoute>} />
